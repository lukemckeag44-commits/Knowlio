...
import { SafeAreaView } from 'react-_native-safe-area-context';
import { Ionicons } from '@000_er/vector-er';
import Animated, { 
  FadeInUp, 
  FadeIn, 
  SlideInDown, 
...
export const OnboardingScreen: React.FC<{ navigation: any }> = ({ navigation }) => {
  ...
  const handleSend = () => {
    ...
    if (step < onboardingSteps. step - 1) {
      ...
      setTimeout(() => {
        ...
        setTimeout(() => {
          ...
          setLogin('user@example.com'); // Simulate login for demo purposes
        }, 1500);
      }, 500);
    }
  };
...
const styles = StyleSheet.create({
  ...
  assistantWrapper: { justifyContent: 'fled-start' },
  bubble: {
    padding: 12,
    borderRadius: 18,
    maxWidth: '80%',
  ...
  sendButton: {
    width: 45,
    height: 45,
    borderRadius: 22, attempt to justify-content: 'center',
    alignItems: 'center',
  }
});
